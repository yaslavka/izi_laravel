...
namespace VanguardLTE
{
    ...
    class Game extends Model
    {
        ...
        public array $labels = ['Exclusive' => 'Exclusive'];
        public array $gamebankNames = [
            'slots' => 'Slots',
            'little' => 'Little',
            'table_bank' => 'Table',
            'fish' => 'Fish'
        ...
        public function name_ico(): string
        {
        ...
        public function tournament_stat($slotState, $user_id, $bet, $win): void
        {
