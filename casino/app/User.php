...
namespace VanguardLTE
{
    class User extends \Illuminate\Foundation\Auth\User implements \PHPOpenSourceSaver\JWTAuth\Contracts\JWTSubject
    {
        ...
        protected string $presenter = 'VanguardLTE\Presenters\UserPresenter';
        ...
        public function emptyShops(): int
        {
            $count = 0;
        ...
        public function update_level($type, $sum): bool
        {
        ...
        public function distributor(): array
        {
